...
urlpatterns = [
    ...
    path("favouritelist", views.FavouriteList.as_view(), name= "favouritelist"),
    ...
    path("<int:offer_id>/favourite", views.FavouriteAdd, name= "favourite"),
    path("<int:offer_id>/deactivateoffer", views.DeactivateOffer, name= "deactivateoffer"),
